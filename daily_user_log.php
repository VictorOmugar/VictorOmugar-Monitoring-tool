                       ...
                       <div class="box-body">
                            <div class="table-responsive">
                                <table class="gridtable">
                                    <?php
                                    $query =mysqli_query($dbconfig,"SELECT EXTRACT(MONTH FROM start_time) as Month, EXTRACT(WEEK FROM start_time) as week, start_time as date, id, user_name as unique_logins, application as application_name, start_time as start_time, end_time as end_time, bases_base_id as bases_base_id, clusters_cluster_id as clusters_cluster_id, centers_center_id as centers_center_id  from monitored_info ")or die("this code is not running");
                                    ?>
