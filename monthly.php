    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            $query =mysqli_query($dbconfig,"SELECT EXTRACT(MONTH FROM start_time) as Month, EXTRACT(WEEK FROM start_time) "
                    . "as Week, count(DISTINCT user_name) as unique_logins, COUNT( application) as number_access, "
                    . "application as application_name, SUM(TIME_TO_SEC(`Total_system_hours`))/60/60 as Total_system_hours "
                    . "from monitored_info group by EXTRACT(MONTH FROM start_time), EXTRACT(WEEK FROM start_time), application;")
                    or die("this code is not running");
            ?>
