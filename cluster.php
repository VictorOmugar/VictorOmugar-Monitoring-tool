                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            <div class="table-responsive">
                                    <?php
                                    $query =mysqli_query($dbconfig,"SELECT cluster_id as cluster_id, cluster_name as cluster_name, bases_base_id as root_base from clusters");
                                    ?>
          ...
          while($row2 = mysqli_fetch_array($query))
             ...
             ?>
                                    ...
                                    <tr>
                                        ...
                                        <td> <?php echo $row2['cluster_id'];?></td>
                                        <td><?php echo $row2['cluster_name'];?></td>
                                        <td><?php echo $row2['root_base'];?></td>
                                    </tr>
