...
if(isset($_POST['submit']))
{
  // getting id from the search by cluster 
    ...
    //geting cluster id from cluster table
    
    $result= mysqli_query($dbconfig,"SELECT cluster_name from clusters WHERE cluster_id='$cluster_id'");
    ...
    <div class="content-wrapper">
                    ...
                    <div class="box box-primary">
                      ...
                      <div class="box-body">
                            <div class="table-responsive">
                                <h3>Total number of unique logins, Application access and Hours of app used in (<?php echo$cluster_name?>)</h3>
                                <table class="gridtable">
                                    ...
                                    FROM monitored_info 
                                    WHERE clusters_cluster_id = ' $cluster_id'
                                    group by   clusters_cluster_id")or die("this code is not running");
                                    ?>
                                
                                        <thead>
                                        <tr>
                                            <th><center>CLUSTER ID</center></th>
                                            <th>MONTH</th>
                                    ...
                                    <tr>
                                        <td><?php echo $row2['clusters_cluster_id'];?></td>
       ...
       <div class="box-body">
                            <div class="table-responsive">
                                <h3>Total number of unique logins, Application access and Hours of app used per Month in (<?php echo$cluster_name?>)</h3>
                                <table class="gridtable">
        <?php
        $query2 =mysqli_query($dbconfig,"SELECT clusters_cluster_id, EXTRACT(MONTH FROM start_time) as Month, "
                . "EXTRACT(WEEK FROM start_time), COUNT(user_name) as unique_logins, COUNT(application) as number_access, "
                . "application as application_name, SUM(TIME_TO_SEC(`Total_system_hours`))/60/60 as Total_system_hours "
                . "from monitored_info WHERE clusters_cluster_id = '$cluster_id' group by EXTRACT(MONTH FROM start_time), "
                . "EXTRACT(WEEK FROM start_time),application")or die("this code is not running");
        ?>
            ...
            <?php
                                    ...
                                    <tr>
                                        <td><?php echo $row3['clusters_cluster_id'];?></td> 
                                        <td><?php echo $month?></td>
                ...
                <div class="box-body">
                            <div class="table-responsive">
                                <h3>Total number of unique logins, Application access and Hours of app used per Week in (<?php echo$cluster_name?>)</h3>
                                <table class="gridtable">
                                
                                    <?php
                                    $query3 =mysqli_query($dbconfig,"SELECT clusters_cluster_id, "
                                            . "EXTRACT(MONTH FROM start_time) as Month, EXTRACT"
                                            . "(WEEK FROM start_time)as week, COUNT(user_name) as unique_logins, "
                                            . "COUNT(application) as number_access, "
                                            . "application as application_name, SUM(TIME_TO_SEC(`Total_system_hours`))/60/60 as Total_system_hours "
                                            . "from monitored_info WHERE clusters_cluster_id = '$cluster_id' group by EXTRACT(MONTH FROM start_time), "
                                            . "EXTRACT(WEEK FROM start_time),application")or mysqli_error();
                                                                        ?>
         ...
         $month=$row4['Month'];
            ...
            echo"no corrent month value";
             ...
             ?>
                                    ...
                                    <tr>
                                        <td><?php echo $row4['clusters_cluster_id'];?></td>
                                        <td><?php echo $month?></td>
                        ...
                        <div class="box-body">
                            <div class="table-responsive">
                                <h3>Total Number of App Access Per User Weekly in (<?php echo$cluster_name?>)</h3>
                                <table class="gridtable">
                                    <?php
                                    $query4 =mysqli_query($dbconfig,"SELECT clusters_cluster_id, 
            ...
            echo"no corrent month value";
             ...
             ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $row5['clusters_cluster_id'];?></td>
                                        <td><?php echo $month?></td>
                ...
                <div class="box-body">
                            <div class="table-responsive">
                                <h3>Total number of Application Access per user  in (cluster name)in(<?php echo$cluster_name?>)</h3>
                                <table class="gridtable">
                                    <?php
                                    $query5 =mysqli_query($dbconfig,"SELECT clusters_cluster_id, 
                                    EXTRACT(MONTH FROM start_time) as Month,
                                    EXTRACT(WEEK FROM start_time) as week, 
                                    start_time as date,
                                    id, 
                                    ...
                                    from monitored_info
                                    WHERE clusters_cluster_id = '$cluster_id' ")or die("this code is not running");
                                    ?>
            ...
            echo"no corrent month value";
             ...
             ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $row6['clusters_cluster_id'];?></td>
