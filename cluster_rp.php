  ...
  <div class="box-body">
        <div class="table-responsive">
            <table class="gridtable">
                <?php
                $query =mysqli_query($dbconfig,"SELECT DISTINCT EXTRACT(MONTH FROM start_time)as Month,"
                        . "count( DISTINCT user_name) as unique_logins ,COUNT(application) as number_access, "
                        . "SUM(TIME_TO_SEC(`Total_system_hours`))/3600 as Total_system_hours from monitored_info where clusters_cluster_id='$cluster_id' "
                        . "group by EXTRACT(MONTH FROM start_time) ")or die("this code is not running");
                ?>
